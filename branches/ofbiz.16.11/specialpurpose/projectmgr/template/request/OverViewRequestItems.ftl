                ...
                <#if custRequestItemNoteViews?has_content>
                    <table class="basic-table table-responsive hover-bar" cellspacing="0">
                        ...
                        <#list custRequestItemNoteViews as custRequestItemNoteViewList>
                            ...
                            <#assign partyNameView = delegator.findOne("PartyNameView", Static["org.apache.ofbiz.base.util.UtilMisc"].toMap("partyId", custRequestItemNoteViewList.partyId), false)!/>
                            <tr class="${row}">
                                <td>
                                </td>
                                <td>
