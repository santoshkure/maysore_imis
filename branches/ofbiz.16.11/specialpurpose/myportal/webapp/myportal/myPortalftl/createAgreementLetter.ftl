...
<#---Program Name: createAgreementLetter.ftl----->
...
<#setting locale="en">
    ...
    <form method="post" name="createAgreementLetters" action="" class="basic-form">
    <div class="row">
...
<pre>
            ...
            <table cellspacing="0" class="basic-table table-responsive">
                <tbody>
                 ...
                 <tr>
		    				...
		    				<input type="button" onclick="javascript:resetVal(document.createAgreementLetters.fileLoc);" value="Reset"/>
  ...
  function createAgreementLetter()
   {
		   var form=document['createAgreementLetters'];
