  ...
  <div class="alert alert-info">
	...
	<table class="basic-table" cellspacing="0">
			...
			<tr>
			 ...
			 <td><input type="text" style="width:140px"  name="description" autocomplete="off" id="remark" maxlength ="30" value="Mysore Street" /></td>    	
			  ...
			  <td> 
				<select name="nameOfService" style="width:150px;" onchange="return getDesignation(this);">
					<option value="">${uiLabelMap.blockName}</option>
				 	<option value="" selected="true">Mysore Block</option>
				</select>
			</td>  
        	...
        	<tr>
                    ...
                    -->
					<td><input type="date" style="width:140px"  name="description" autocomplete="off" id="remark" maxlength ="10" value="31/07/2017" /></td> 
