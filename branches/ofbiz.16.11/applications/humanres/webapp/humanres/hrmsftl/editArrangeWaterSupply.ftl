...
<#---Program Name: editArrangeWaterSupply.ftl----->
<#--------------------------------------------Description: -------------------------------------------------> 
<#-- #####################################################################################################-->
<#---Version Number		Author 		Date Created 		Date Modified   --->
<#---1.0			Nikhil Pathak   09/08/2017
<#-- #####################################################################################################-->
<#--This ftl is used to show the application for Edit Arrange Water Supply-->


<#setting locale="en">
   
    <form method="post" name="editArrangeWaterSupply" action="" class="basic-form">
    <div class="row">
	    <div class="alert alert-info">
		    <ul>
		        <li class="back"><a href = "javascript:history.go(-1);">${uiLabelMap.CommonBack}</a></li>
		    	<div class="h3" align="center">${uiLabelMap.editArrWaterSupply}</div>
			</ul>
		</div>
                ...
                <tbody>
                   ...
                   <tr>
                      ...
                      <tr>
                    	  <td colspan="4"><center>
                    	  <div id ="saveBtn">
                    	  <input name="save"   type="button" value="${uiLabelMap.CommonUpdate}" onClick="javascript:editArrangeWater('editArrangeWaterSupply');"/>
  ...
  <script type="text/javascript" language="javascript">
   ...
   function editArrangeWater(editArrangeWaterSupply)
   {
		   var form=document['editArrangeWaterSupply'];
