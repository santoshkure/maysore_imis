		...
		<fo:table-cell padding="6pt" border="0.5pt solid black" number-columns-spanned="7" >
 		...
 		<fo:table-row>
 				...
 				<fo:table-cell  border="0.8pt solid black"  number-rows-spanned="1">
           		...
           		<fo:table-cell  border="0.8pt solid black"  number-rows-spanned="1">
           	      <fo:block font-weight="bold">Customer Name</fo:block>
           		</fo:table-cell>
           		<fo:table-cell  border="0.8pt solid black"  number-rows-spanned="1">
           ...
           <#if searchCustomerList?has_content>
	      	<#assign x = searchCustomerList?size/>
            <#assign i = 1>
	      ...
	      <fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchCustomerList.customerId?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchCustomerList.firstName?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchCustomerList.mobileNumber?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchCustomerList.address?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      <fo:block> ${searchCustomerList.actionDate?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchCustomerList.actionStatus?if_exists}</fo:block>
	      	</fo:table-cell>
	        </fo:table-row>
