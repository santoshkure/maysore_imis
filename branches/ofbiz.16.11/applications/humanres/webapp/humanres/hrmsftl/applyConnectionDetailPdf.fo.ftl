		...
		<fo:table-cell padding="6pt" border="0.5pt solid black" number-columns-spanned="7" >
 		...
 		<fo:table-row>
 				...
 				<fo:table-cell  border="0.8pt solid black"  number-rows-spanned="1">
           		...
           		<fo:table-cell  border="0.8pt solid black"  number-rows-spanned="1">
           	      <fo:block font-weight="bold">Application Date</fo:block>
           		</fo:table-cell>
           		<fo:table-cell  border="0.8pt solid black"  number-rows-spanned="1">
           	      <fo:block font-weight="bold">Payment Status</fo:block>
           		</fo:table-cell>
        </fo:table-row>  
           
           <#if searchApplyConnectionList?has_content>
	      	<#assign x = searchApplyConnectionList?size/>
            <#assign i = 1>
	      ...
	      <fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchApplyConnectionList.customerId?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchApplyConnectionList.connectionCategory?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchApplyConnectionList.applicationType?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchApplyConnectionList.typeOfBuilding?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      <fo:block> ${searchApplyConnectionList.applicationDate?if_exists}</fo:block>
	      	</fo:table-cell>
	      	<fo:table-cell  border="0.8pt solid black">
	      	<fo:block> ${searchApplyConnectionList.paymentStatus?if_exists}</fo:block>
	      	</fo:table-cell>
	        </fo:table-row>
