/*
 * ADDED BY SHUBHAM MALVIYA FOR APPROVED CONNECTION SEARCHING
...
connectionNo = parameters.connectionNo;
...
List<EntityCondition> andExprs = new LinkedList<EntityCondition>();
       ...
       if(UtilValidate.isNotEmpty(connectionNo)) {
					andExprs.add(EntityCondition.makeCondition("connectionNo",
						EntityOperator.EQUALS,connectionNo));
				}
...
searchConnectionList = connectionList.getPartialList(lowIndex, highIndex - lowIndex + 1)
...
context.searchConnectionList = searchConnectionList
context.connectionNo = connectionNo
