...
Date.prototype.toFormattedString = function(include_time) {
  //Commented to display the date indian format yyyy-mm-dd instead dd/mm/yyyy
...
function call_cal(target, datetime) {
    new CalendarDateSelect(target, {year_range:60} );
}
...
function call_cal_time(target, datetime) {
   new CalendarDateSelect(target, {time:true, year_range:60} );
}
