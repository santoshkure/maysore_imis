  ...
  <div class="alert alert-info">
	...
	<table class="basic-table" cellspacing="0">
			...
			<tr>
			 ...
			 <td><input type="text" style="width:140px"  name="description" autocomplete="off" id="remark" maxlength ="30" value="Mysore Zone" /></td>    	
			  ...
			  <td> 
				<select name="nameOfService" style="width:150px;">
				    <option value="">${uiLabelMap.officeName}</option>
				 	<option value="" selected="true">WRD</option>
