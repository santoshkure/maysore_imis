...
<#---Program Name: editIssueWorkOrder.ftl----->
...
<#-- #####################################################################################################-->
<#--This ftl is used to show edit Issue Work Order -->

<#setting locale="en">
   
    <form method="post" name="editIssueWorkOrder" action="" class="basic-form">
    <div class="row">
	    <div class="alert alert-info">
		    <ul>
		     <li class="back"><a href = "javascript:history.go(-1);">${uiLabelMap.CommonBack}</a></li>
		    	<div class="h3" align="center"><b>${uiLabelMap.editIssueWorkOrder}</b></div> 
			</ul>
		</div>
                ...
                <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                    	 <td colspan="4"><center>
                    	 <div id ="update">
                    	 <input name="update"   type="button" value="${uiLabelMap.CommonUpdate}" onClick="javascript:editWorkOrder();"/>
  ...
  function editWorkOrder()
   {
		   var form=document['editIssueWorkOrder'];
