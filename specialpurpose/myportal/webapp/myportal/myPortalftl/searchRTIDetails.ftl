  ...
  <div class="row">
	...
	<table class="basic-table" cellspacing="0">
		<tr>
       	...
       	<tr>
			<td colspan="8"><center><div id="search" align="center"><input type="button"  name="search" value="Search" onclick="javascript:validateDetails('searchRTIDetails');"></center></td>
		</tr>
	</tr>
	</table>
	</div>
   ...
   <div class="">
    ...
    <thead>
         <tr class="header-row-2">
             ...
             <td><center>${uiLabelMap.applicationChallanRefrenceNo}</center></td>
       ...
       <tr>
				...
				<td><center><a href="javascript:editRTIDetails('searchRTIDetails');" class="buttontext" align="center">Edit</a></center></td>
