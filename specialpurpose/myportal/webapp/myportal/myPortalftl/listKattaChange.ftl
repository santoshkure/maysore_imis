...
<#---Program Name: listKattaChange.ftl----->
<#---Description: --->
<#---Version Number    1.0 --->
<#--- Author          	Date Created     -->
...
<div class="row">
  <div class="alert alert-info">
    <ul>
      <li class="h3">${uiLabelMap.khattaList}</li>
    </ul>
    ...
    <thead>
         <tr class="header-row-2">
	        ...
	        <td><center>${uiLabelMap.connectionNo}</center></td>
             ...
             <td><center>${uiLabelMap.changeKhata}</center></td>
       ...
       <tr>
				...
				<td><center><a class="buttontext"  align="center" href="<@ofbizUrl>kattaChangeRequest</@ofbizUrl>"><font color="blue">Change Khata</font></a></center></td>
